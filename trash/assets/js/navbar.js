...
let show1 = () =>{
  if(showstatus == false){
    for (var i=0; i<3; i++){
      let getSubMenu = document.querySelectorAll(".hide1")[i].style.display = "block";
      document.querySelector(".rotate1").style.transform = "rotate(450deg)"
    }
  showstatus = true;
  }else if(showstatus == true){
  for (var i=0; i<3; i++){
      let getSubMenu = document.querySelectorAll(".hide1")[i].style.display = "none"
...
if(showstatus == false){
  for (var i=0; i<4; i++){
    let getSubMenu = document.querySelectorAll(".hide2")[i].style.display = "block";
    document.querySelector(".rotate2").style.transform = "rotate(450deg)"
  }
showstatus = true;
}else if(showstatus == true){
for (var i=0; i<4; i++){
    let getSubMenu = document.querySelectorAll(".hide2")[i].style.display = "none"
...
if(showstatus == false){
  for (var i=0; i<6; i++){
    let getSubMenu = document.querySelectorAll(".hide3")[i].style.display = "block";
    document.querySelector(".rotate3").style.transform = "rotate(450deg)"
  }
showstatus = true;
}else if(showstatus == true){
for (var i=0; i<6; i++){
    let getSubMenu = document.querySelectorAll(".hide3")[i].style.display = "none";
